...
public sealed record ExportDetailResponse(Guid Id, Guid ArtifactVersionId, Guid GeneratedArtifactId, Guid ProjectId, OutputFormat Format, ExportStatus Status, string FileName, string Content, DateTimeOffset CreatedAtUtc);
